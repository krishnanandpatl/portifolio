      ...
      <div className="verizonMainBox">
        ...
        <div className="verizonResearchMainBox">
          ...
          <div className="researchExperienceBox">
            <div className="researchExprienceTitle">
              Current Experience Study
            </div>
          ...
          <div className="ResearchMainBox">
            ...
            <div className="verizonkeyBox">
              ...
              <div className="keyBoxContent">
                <ul>
                  <li>
                    Salesforce and Oracle CPQ platforms offer extensive
                    cross-team collaboration features, such as file sharing,
                    scheduling, and review processes.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    capabilities, while Zoho CRM's integration options may be
                    more limited.
                  </li>
                  <li>
                    Examples of 3rd party integrations vary among the platforms,
                    with Salesforce offering the most options, including Slack
                    and Jira, and Zoho CRM integrating with G Suite and Office
                    365.
                  </li>
                </ul>
              </div>
        ...
        <div className="verizonExperienceBusinessMainBox">
          <div className="ExperienceBusinessTitleBox">
            ...
            <p className="ExperienceBusinessTitle1">
              ...
              business. The four principles we identified were:
            </p>
          </div>
              ...
              <div className="ExperienceBusinessTitlecontentRightContent">
                <ul>
                  <li>
                    ...
                    for users, simplifying the user experience and allowing for
                    a 360-degree view of the customer's account
                  </li>{" "}
                  <br />
                  <li>
              ...
              <div className="ExperienceBusinessTitlecontentRightContent">
                <ul>
                  <li>
                    ...
                    users to complete tasks with ease and confidence, resulting
                    in increased productivity and satisfaction levels
                  </li>{" "}
                  <br />
                  <li>
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  making it easier for them to access the tools and information
              ...
              <tr>
                ...
                <td>
                  ...
                  users with real-time insights into their performance and help
          ...
          <div className="myImpactContentBox">
            ...
            <div className="myImpactContentRight">
              ...
              <p className="myImpactContentContext">
                ...
                different departments resulting in faster decision-making,
                saving 30 minutes per task on average.
              </p>
              <p className="myImpactContentContext">
            ...
            <div className="verizonPredictionContentBox">
              ...
              <div className="verizonPredictionRight">
                ...
                <p className="myImpactContentTitle">
                  ...
                  increase in the number of completed tasks and a 10% reduction
                ...
                <p className="myImpactContentContext">
                  ...
                  KPIs. We believe that these improvements will have a
                  significant impact on the success of the VZ 360 project and
                  the overall satisfaction of its users.
                </p>
              </div>
            </div>
          </div>
