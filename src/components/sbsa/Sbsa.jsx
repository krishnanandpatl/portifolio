    ...
    <div>
      ...
      <div class="subex-intro-card">
        <div class="text-part-intro">
          <h1 class="heading-intro-subex">
            Redesigning Standard Bank South Africa's BOL Portal for an Enhanced
            Business Banking Experience
          </h1>
          <p class="para-intro-card">
            We prioritized usability, accessibility, and visual design to create
            a modern and intuitive portal that offers a seamless banking
          ...
          <div class="timeline-intro-card">
            <div class="flex-titles-intro">
              ...
              <div class="title-details-intro">Oct 2018 - June 2019</div>
            </div>
            <div class="flex-titles-intro">
      ...
      <div class="inner-container-subex">
        <div class="context-background-subex">
          ...
          <p>
            Till Recently Standard Bank South Africa was using Legacy Interface
            for most of its offering which worked like magic. But this magic
            receded to a slew of disparate features that made the experience
            slow and complex to use. hence the need came to Migrate from Legacy
            interface to BOL (Business Online) Standard Bank.
          </p>
          <p>
          ...
          <div>
            ...
            <div>
              <div>Corporate Finance Managers</div>
              <div>
                who use the platform to manage multiple accounts, payments, and
                transactions on behalf of their company
              </div>
            </div>
            <div>
              <div>Treasury Managers</div>
              <div>
        ...
        <div class="project-scope-sbsa">
          ...
          <p>
            ...
            suggesting design solutions, and testing those solutions to create a
            more intuitive and user-friendly module.
          </p>
          <p>
            While this project was part of a larger effort to improve the
            overall banking experience for business users. It should be noted
            that this case study will only discuss the consolidated balances
            module and not the entire Standard Bank BOL portal redesign project.
          </p>
        </div>
        <div class="buisness-objective-sbsa">
          <h1>Buisness Objective</h1>
          <p>
            To provide Standard Bank's business customers with a streamlined and
            user-friendly way to view and manage their balances. By reducing the
            time it takes for customers to complete balance-related tasks,
            increasing customer satisfaction and improving the accuracy of
            balance reporting.
          </p>
          <p>
        ...
        <div class="design-challenge-sbsa">
          ...
          <p>
            ...
            subgroups, and select balance types, while ensuring that the process
            is intuitive and clear, regardless of the user's level of financial
            expertise?
          </p>
        </div>
        <div class="solution-sbsa">
          <h1>The Solution</h1>
          <p>
            We simplified the navigation by placing consolidated balances on the
            level 1 navigation and introduced search and refresh options
            prominently.
          </p>
          <p>
            We also included all account subgroups at level 2 to reduce
            cognitive load. As a result, user testing showed that 18
            participants found the new navigation and search features helpful in
            locating consolidated balances within a minute.
          </p>
        </div>
        <div class="partition-line-sbsa"></div>
        <div class="discover-sbsa">
          <h1>Discover</h1>
          <p>
          ...
          <div class="discover-box2">
            <h2>Standard bank-Consolidated Balances | Users Testing report</h2>
            <div class="discover-line-sbsa"></div>
            <div class="experience-card-sbsa">
              <div>
                <div>
                ...
                <div>
                  ...
                  <ol>
                    ...
                    <li>
                      Adding subgroup "Company B" from account group "Logistics"
                      to the consolidated form
                    </li>
                    <li>
            ...
            <h3>User Insights</h3>
            <div class="discover-results-sbsa">
              <div>
                <div>icon</div>
                <h5>Obstacles</h5>
                <ol>
                  <li>
                    The interface is outdated and clunky, making it difficult to
                    navigate and complete tasks efficiently.
                  </li>
                  <li>
                    There are too many steps and clicks required to perform
                    basic tasks, causing frustration and wasting valuable time.
                  </li>
                  <li>
              ...
              <div>
                ...
                <ol>
                  <li>
                    A simpler and more streamlined process should be implemented
                    of adding and removing accounts
                  </li>
                  <li>
                    The current options for selecting balance types are
                    confusing and unclear. The meaning of each option should be
                    made clearer and more intuitive.
                  </li>
                  <li>
                    The navigation within the consolidated balances feature can
                    be improved to make it easier for users to find what they
                    are looking for.
                  </li>
                  <li>
            ...
            <div class="feedback-summary-sbsa">
              ...
              <ul>
                ...
                <li>
                  Participants reported that the process of adding and selecting
                  accounts and subgroups was overly complicated and required too
            ...
            <div class="takeways-sbsa">
              ...
              <ul>
                ...
                <li>
                  The available options were not clearly labeled and the search
                  feature did not provide helpful results.
                </li>
              </ul>
              <p>
                Actions: Based on the feedback received, it is recommended that
                the design and organisation of the feature be simplified to make
                it more user-friendly and intuitive. Additionally, providing
                clearer labelling and more helpful search functionality may
                improve the overall usability of the feature.
              </p>
            </div>
          </div>
        </div>
        ...
        <table>
          ...
          <tr>
            <td>Nedbank</td>
            <td>
              Consolidated balance feature Alerts and notifications Transaction
              history Mobile app
            </td>
            <td>
          ...
          <tr>
            <td>FNB</td>
            <td>
              Consolidated balance feature Account grouping and filtering Mobile
              app Budgeting tools
            </td>
            <td>
        ...
        <div>
          We conducted a heuristic evaluation of the current legacy system using
          Nielsen's 10 usability heuristics. We analyzed the system's
          navigation, information architecture, and visual design to identify
          potential areas for improvement. Through this evaluation, we were able
          to identify several critical issues that needed to be addressed to
        ...
        <table>
          ...
          <tr>
            ...
            <th>
              ...
              visible feedback to indicate whether the transaction is processing
          ...
          <tr>
            ...
            <th>
              If a user accidentally deletes a transaction or changes an account
              balance incorrectly, there is no clear way to revert back to the
              original state.
            </th>
            <th>Medium</th>
            <th>Moderate</th>
          ...
          <tr>
            ...
            <th>
              Some buttons are located in different places on different screens,
              and the font sizes and styles used for headings and labels are
              inconsistent.
            </th>
            <th>High</th>
            <th>Easy</th>
          ...
          <tr>
            ...
            <th>
              Users may need to remember account numbers when navigating between
              screens, rather than having the system display the account name or
              type
            </th>
            <th>Low</th>
            <th>Easy</th>
          ...
          <tr>
            ...
            <th>
              ...
              commonly used functions or data, rather than having the option to
              create shortcuts or personalised dashboards
            </th>
            <th>Medium</th>
            <th>Difficult</th>
          </tr>
          <tr>
            ...
            <th>
              The dashboard and account summary screens include too many icons,
              graphs, and tables, making it difficult for users to quickly find
          ...
          <tr>
            ...
            <th>
              The online help centre doesn't have clear instructions or relevant
              FAQs, and the system doesn't provide tooltips or tutorials to
              guide users.
            </th>
            <th>Low</th>
            <th>Moderate</th>
        ...
        <div class="brainstorm-sbsa">
          <h3>Step #1: Brainstorming</h3>
          <p>
            We used SCAMPER a Creative Thinking Technique to generate ideas for
          ...
          <div>
            We substituted the current static interface with a dynamic one that
            updates in real-time, combining it with a feature that allows users
            to set alerts for certain account activity.
          </div>
          <p>View SCAMPER report</p>
        </div>
        <div class="categorized-idea-sbsa">
          ...
          <p>
            ...
            Some examples of ideas that emerged from the brainstorming sessions
            include:
          </p>
          <div>
          ...
          <div>
            ...
            <p>
              Introducing interactive graphs to visualise account activity over
              time.
            </p>
          </div>
          <div>
            ...
            <p>
              Adding a feature that recommends actions to take based on account
        ...
        <div class="prioritization-sbsa">
          <h3>Step #3: Prioritization</h3>
          <p>
            We then used SCAMPER brainstorming exercises to generate ideas and
            categorised them based on common themes. From these, we prioritised
            the top ideas, including:
          </p>
          <div>
            <h5>Simplification of Navigation and Information Architecture</h5>
            <p>
              This idea was prioritised because it addresses a fundamental issue
              with the feature's usability, which was a significant pain point
              for users during testing. By making it easier for users to find
              and understand the information they need, we can improve the
              overall user experience.
            </p>
          </div>
        </div>
        <div class="solution-building-sbsa">
          <h1>Solution Building</h1>
          <p>
            After the ideation sessions, we conducted a thorough analysis of the
            existing IA and information flow of the platform.
          </p>
          <h4>User Workflow</h4>
          <ul>
            <li>
        ...
        <div class="approach1-sbsa">
          <p>
            ...
            while navigating and locating menus on the platform. Following a few
            iterations, we finalised on two approaches to tackle these issues,
            which are:
          </p>
          <div>
            <div>
              ...
              <ol>
                <li>
                  We suggested putting the consolidated balances feature in the
                  level 1 of the navigation, along with Accounts, Balances, Find
                  a Transaction and Download Report.
                </li>
                <li>
                  Additionally, we recommended including All Account and
                  Accounts Subgroups under the Accounts tab at level 2, along
                  with search and refresh options that are prominently displayed
                  on the page.
                </li>
              </ol>
              <h5>Impact:</h5>
              <ul>
                <li>
                  Approach 1 reduces cognitive load and improve decision-making
                  for the user. By organising the information architecture in a
                  clear and intuitive manner, users can quickly find the
                  information they need and make informed decisions about their
                  finances.
                </li>
                <li>
        ...
        <div class="approach2-sbsa">
          <div>
            ...
            <ul>
              <li>
                Approach 2 aims to reduce the cognitive load and decision-making
                effort required by users by providing them with easy access to
        ...
        <div class="deliver-wireframes-sbsa">
      ...
      <div class="testing-report-sbsa">
        ...
        <div class="summary-results-sbsa">
          <h3>Summary Results</h3>
          <p>
            Overall, the new design changes were well received by participants.
            All participants were able to complete the tasks successfully, with
            an average completion time of 6 minutes and 30 seconds.
          </p>
          <p>
          ...
          <div>
            ...
            <div>
              <div class="task2-result-sbsa">
                Task 2: Export a report of consolidated balances for the past 6
                months
              </div>
              <div>
                <div></div>
            ...
            <div>
              <div class="task4-result-sbsa">
                Task 4: Find transactions related to a specific account subgroup
              </div>
              <div>
                <div></div>
                <div></div>
          ...
          <div class="common-observation-sbsa">
      ...
      <div class="mylearning-sbsa">
        ...
        <div>
          ...
          research findings, discussing roadblocks, and working together towards
          achieving common goals that address both user needs and business
          objectives.
        </div>
        <div>
          Although we are still evaluating the results based on key performance
          indicators, it is clear that our solutions have had a positive impact
          on usability and user experience.
        </div>
        <div>
          Above all, this project provided me with the opportunity to work with
          a diverse user base in an unfamiliar industry, which has expanded my
          skills and knowledge as a designer.
        </div>
      </div>
      <div class="future-directions-sbsa">
        <div>
      ...
      <div class="process-tools-sbsa">
        ...
        <div>
          ...
          <div>
            ...
            <p>
              We used Guerrilla User testing for testing concepts with the users
            </p>
          </div>
        </div>
      </div>
