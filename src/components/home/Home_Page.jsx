        ...
        <div className="homeProjectBox">
          ...
          <div className="homeProjectBox-Project1">
            <div className="homeProjectBox-Project1-left">
              <div className="homeProjectBox-Project1-left-Title">
                Verizon Sales 360
              </div>
              <div className="homeProjectBox-Project1-left-Text">
                <div className="homeProjectBox-Project1-left-Text-icon">
                  <img src={Group1683} alt="Group1683" />
                </div>
                <div className="homeProjectBox-Project1-left-TextLine">
                  Greenfield Project
                </div>
              </div>
              <div className="homeProjectBox-Project1-left-Details">
                A comprehensive digital landscape that supports 22k business
                customers across 338k sites.
              </div>
              <div
                className="homeProjectBox-Project1-left-Link"
                onClick={() => LinkFn("/restricted", "/verizon-360")}
              >
                <div className="homeProjectBox-Project1-left-Link-Text">
                  View case study
                </div>
                <div className="homeProjectBox-Project1-left-Link-Icon">
                  <img src={openInNew} alt="OpenInNew" />
                </div>
              </div>
            </div>
            <div className="homeProjectBox-Project1-Right">
              <img src={P1_Image} loading="lazy" alt="P1" />
            </div>
          </div>
          <div className="homeProjectBox-Project1">
            <div className="homeProjectBox-Project2-Left">
              <img src={P2_Image} loading="lazy" alt="P2" />
            </div>
            <div className="homeProjectBox-Project2-Right">
              ...
              <div className="homeProjectBox-Project1-left-Details">
                ...
                and efficient platform for marketing teams to manage their
          ...
          <div className="homeProjectBox-Project1">
            <div className="homeProjectBox-Project1-left">
              ...
              <div className="homeProjectBox-Project1-left-Details">
                ...
                service providers. <br /> The company is listed on BSE and NSE
                in India.
              </div>
              <div
                className="homeProjectBox-Project1-left-Link"
            ...
            <div className="homeProjectBox-Project1-Right">
              <img src={P3_Image} loading="lazy" alt="P3" />
            </div>
          </div>
          <div className="homeProjectBox-Project1">
            <div className="homeProjectBox-Project2-Left">
              <img src={P4_Image} loading="lazy" alt="P4" />
            </div>
            <div className="homeProjectBox-Project2-Right">
              <div className="homeProjectBox-Project1-left-Title">
                Standard Bank
          ...
          <div className="homeProjectBox-Lower-FlexBox">
            <div className="homeProjectBox-Lower-ProjectBox">
              <div className="homeProjectBox-Lower-ProjectBox-Top">
                <div className="homeProjectBox-Lower-ProjectBox-Top-Heading">
                  Moneytap Banker's Portal
                </div>
                <div className="homeProjectBox-Lower-ProjectBox-Top-TitleBox">
                  <div className="homeProjectBox-Lower-ProjectBox-Top-TitleBox-Icon">
                    <img src={Group1683} alt="Group1683" />
                  </div>
                  <div className="homeProjectBox-Lower-ProjectBox-Top-TitleBox-Text">
                    Hybrid Project
                  </div>
                </div>
                <div className="homeProjectBox-Lower-ProjectBox-Top-Details">
                  MoneyTap is India’s first app-based personal credit line,
                  offered in partnership with banks and NBFCs.{" "}
                </div>
                <div className="homeProjectBox-Project1-left-Link margin28">
                  <div
                    className="homeProjectBox-Project1-left-Link-Text"
              ...
              <div className="homeProjectBox-Lower-ProjectBox-Lower">
                <img src={P5_Image} loading="lazy" alt="P5" />
              </div>
            </div>
            <div className="homeProjectBox-Lower-ProjectBox">
              <div className="homeProjectBox-Lower-ProjectBox-Top">
                ...
                <div
                  className="homeProjectBox-Project1-left-Link margin28"
                  onClick={() => LinkFn("/dell")}
                >
                  <div className="homeProjectBox-Project1-left-Link-Text">
                    View case study
              ...
              <div className="homeProjectBox-Lower-ProjectBox-Lower">
                <img src={P6_Image} loading="lazy" alt="P6" />
              </div>
            </div>
            <div className="homeProjectBox-Lower-ProjectBox">
              {" "}
              ...
              <div className="homeProjectBox-Lower-ProjectBox-Lower">
                <img src={P7_Image} loading="lazy" alt="P7" />
              </div>
            </div>
          </div>
        </div>
